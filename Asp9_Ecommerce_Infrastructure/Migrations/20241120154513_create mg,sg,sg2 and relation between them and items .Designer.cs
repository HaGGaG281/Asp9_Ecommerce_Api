...
namespace Asp9_Ecommerce_Infrastructure.Migrations
{
    ...
    [Migration("20241120154513_create mg,sg,sg2 and relation between them and items ")]
    partial class createmgsgsg2andrelationbetweenthemanditems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.Cities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.Classifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.CustomerStores", b =>
                {
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.Governments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.InvoiceDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.Invoices", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("Recieved_date")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.ItemsUnits", b =>
                {
                    b.Property<int>("ItemCode")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.ShoppingCartItem", b =>
                {
                    ...
                    b.Property<int>("U_Code")
                        .HasColumnType("int");

                    b.Property<DateTime?>("UpdatedAt")
                        .HasColumnType("datetime2");

                    b.HasKey("Cus_Id", "Store_Id", "ItemCode");
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.Stores", b =>
                {
                    ...
                    b.Property<int>("Government_Code")
                        .HasColumnType("int");

                    b.Property<int>("Zone_Code")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.Zones", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.Cities", b =>
                {
                    b.HasOne("Asp9_Ecommerce_Core.Models.Governments", "Governments")
                        .WithMany("Cities")
                        .HasForeignKey("Gov_Code")
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.CustomerStores", b =>
                {
                    b.HasOne("Asp9_Ecommerce_Core.Models.Users", "Users")
                        .WithMany()
                        .HasForeignKey("Cus_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Asp9_Ecommerce_Core.Models.Stores", "Stores")
                        .WithMany()
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.InvoiceDetail", b =>
                {
                    b.HasOne("Asp9_Ecommerce_Core.Models.Invoices", "Invoices")
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.ItemsUnits", b =>
                {
                    ...
                    b.HasOne("Asp9_Ecommerce_Core.Models.Units", "Units")
                        .WithMany("ItemsUnits")
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.Stores", b =>
                {
                    b.HasOne("Asp9_Ecommerce_Core.Models.Cities", "Cities")
                        .WithMany("Stores")
                    ...
                    b.HasOne("Asp9_Ecommerce_Core.Models.Governments", "Governments")
                        .WithMany("Stores")
                        .HasForeignKey("Government_Code")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Asp9_Ecommerce_Core.Models.Zones", "Zones")
                        .WithMany("Stores")
                        .HasForeignKey("Zone_Code")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Asp9_Ecommerce_Core.Models.Users", b =>
                {
                    ...
                    b.HasOne("Asp9_Ecommerce_Core.Models.Classifications", "Classifications")
                        .WithMany("Users")
                        .HasForeignKey("Cus_ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Asp9_Ecommerce_Core.Models.Users", null)
                        .WithMany()
